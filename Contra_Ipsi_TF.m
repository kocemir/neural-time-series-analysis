...
subplot(2,2,pos)
contourf(subject.EEG{sb}.times,subject.frex{sb},(squeeze( mean(mean(pChan_pSubject_All(:,:,:,cn,:),1),5)))',80,'linecolor','none')
set(gca,'clim',[-1 1],'xlim',[-200 1000],'yscale','log','ytick',logspace(log10(min_freq),log10(max_freq),6),'yticklabel',round(logspace(log10(min_freq),log10(max_freq),6)*10)/10)
legend(legatns(cn))
